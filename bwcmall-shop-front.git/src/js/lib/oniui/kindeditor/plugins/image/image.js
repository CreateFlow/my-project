...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<div class="ke-dialog-row">',
			hiddenElements.join(''),
			'<label style="display:none;" style="width:60px;">' + lang.localUrl + '</label>',
			'<input style="display:none;" type="text" name="localUrl" class="ke-input-text" tabindex="-1" style="width:200px;" readonly="true" /> &nbsp;',
